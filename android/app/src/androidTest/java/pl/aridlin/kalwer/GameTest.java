...
public final class GameTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testGamePopupFocusAndPermanentUnlock()throws Throwable {
        ...
        assertNotNull(popup());Thread.sleep(700);
        ...
        getInstrumentation().sendKeyDownUpSync(android.view.KeyEvent.KEYCODE_ENTER);Thread.sleep(500);
        ...
        runTestOnUiThread(()->{try{popup().setResumed(true);}catch(Exception e){throw new RuntimeException(e);}});Thread.sleep(350);assertTrue(new JSONObject(GameNative.info()).getDouble("elapsed")>paused);
    ...
    public void testKoomNativeRuntimeAndAudioPause()throws Throwable {
        ...
        long deadline=System.currentTimeMillis()+10000;while(popup()==null && System.currentTimeMillis()<deadline)Thread.sleep(100);assertNotNull(popup());Thread.sleep(700);
