...
elephant-field: main.cpp build-koom/bundle.o appearance.hpp live_backdrop.hpp backdrop_linux.hpp protocols/toplevel-protocol.o peggle.hpp garden.hpp chess.hpp shop.hpp tetris.hpp breakout.hpp koom.hpp calculator_format.hpp passive_koins.hpp games.hpp games_gtk.hpp gpu_game.hpp gpu_dither.hpp elevation_linux.hpp system_file_index.hpp launcher_commands.hpp update_status.hpp
...
build-koom/kalwer-koom: koom/host.c koom/build.py $(wildcard vendor/doomgeneric/*.[ch])
	python3 koom/build.py

build-koom/bundle.o: build-koom/kalwer-koom assets/koom/freedoom2.wad
	ld -r -b binary assets/koom/freedoom2.wad build-koom/kalwer-koom -o $@
